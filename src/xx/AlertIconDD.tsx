...
export const AlertIcon = React.forwardRef<SVGSVGElement, IconProps>(({ variant = 'primary', color = '#fff', size = 24, ...props }, forwardedRef) => {
	// VARIANTS

	const primary = (
		<svg width='58' height='52' viewBox='0 0 58 52' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			<path d='M29 38V38.03M29 20V26V20Z' stroke='#D83D3D' stroke-width='3' stroke-linecap='round' stroke-linejoin='round' />
			<path
