...
export const IncAlphaIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	// props
	...
	const primary = (
		<svg {...props} width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			<g clip-path='url(#clip0_11845_14525)'>
				<path d='M5.33398 14.5L7.83398 17L10.334 14.5' stroke='#E2E2E2' stroke-linecap='round' stroke-linejoin='round' />
				<path d='M7.83398 7V17' stroke='#E2E2E2' stroke-linecap='round' stroke-linejoin='round' />
				<path
