...
export const InstaIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
		...
		<svg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g clip-path='url(#clip0_1703_83997)'>
				...
				<path
					...
					stroke-linejoin='round'
				/>
				<path d='M13.75 6.25V6.251' stroke='#ABABAB' stroke-linecap='round' stroke-linejoin='round' />
			</g>
			<defs>
...
export default React.memo(InstaIcon)
