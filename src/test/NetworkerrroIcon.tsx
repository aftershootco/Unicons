...
export const NetworkerrroIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
	...
	const primary = (
		<svg width='96' height='96' viewBox='0 0 96 96' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			<g clip-path='url(#clip0_18341_4857)'>
				<path d='M48 64H48.0267' stroke='#D83D3D' stroke-width='3' stroke-linecap='round' stroke-linejoin='round' />
				<path
...
export default React.memo(NetworkerrroIcon)
