...
const DeleteIcon3: React.FC<React.SVGProps<SVGSVGElement>> = React.memo((props) => {
	return (
		<svg width='60' height='66' viewBox='0 0 60 66' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			<path
