...
const GridNotSelectedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg {...props} width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<rect width='22' height='22' rx='2' fill='transparent' fill-opacity='0.1' />
...
export default GridNotSelectedIcon
