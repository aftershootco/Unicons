...
const SprayClickIcon3: React.FC<React.SVGProps<SVGSVGElement>> = React.memo((props) => {
	return (
		<svg width='35' height='35' viewBox='0 0 35 35' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			...
			<defs>
				<clipPath id='a'>
					<path fill='#fff' transform='translate(9 6)' d='M0 0h16v23H0z' />
				</clipPath>
			</defs>
		</svg>
	)
...
export default SprayClickIcon3
