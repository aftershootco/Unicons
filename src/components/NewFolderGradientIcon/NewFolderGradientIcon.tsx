...
const NewFolderGradientIcon: React.FC<React.SVGProps<SVGSVGElement>> = React.memo((props) => {
	return (
		<svg width='329' height='200' viewBox='0 0 329 200' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			<ellipse
				opacity='0.4'
				rx='161'
				ry='186'
				transform='matrix(2.1817e-08 -1 -1 -7.83036e-09 168 209)'
				fill='url(#paint0_linear_14989_10969)'
			/>
...
export default NewFolderGradientIcon
