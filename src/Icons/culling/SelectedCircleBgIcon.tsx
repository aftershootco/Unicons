...
export const SelectedCircleBgIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
	...
	const primary = (
		<svg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<circle cx='10' cy='10' r='10' fill={bgColor} fillOpacity={DEFAULT_ICON.BG_OPACITY} />
			<path
...
export default React.memo(SelectedCircleBgIcon)
