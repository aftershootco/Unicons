...
const LoaderIcon = React.forwardRef<SVGSVGElement, IconProps>((props, forwardedRef) => {
	...
	const primary = (
		...
		>
			...
			<path d='M12.1875 12.9072L13.8 14.5197' stroke={modifiedColor} stroke-linecap='round' stroke-linejoin='round' />
			<path d='M9 14.2197V16.4697' stroke={modifiedColor} stroke-linecap='round' stroke-linejoin='round' />
			<path d='M5.81221 12.9072L4.19971 14.5197' stroke={modifiedColor} stroke-linecap='round' stroke-linejoin='round' />
			<path d='M4.5 9.71973H2.25' stroke={modifiedColor} stroke-linecap='round' stroke-linejoin='round' />
