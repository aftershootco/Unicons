...
const StorageIcon = React.forwardRef<HTMLSpanElement, IconProps>((props, forwardedRef) => {
	//props
		...
		<svg width={size} height={size} viewBox='0 0 64 64' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g clip-path='url(#clip0_14619_11844)'>
				...
				<path
					...
					stroke-linejoin='round'
				/>
				<path d='M8 8L56 56' stroke={modifiedColor} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
			</g>
			<defs>
