...
export const AlertTriangleIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	...
	// variants
	const primary = (
		<svg width={size} height={(52 / 58) * size} viewBox='0 0 58 52' fill='none' xmlns='http://www.w3.org/2000/svg'>
