...
export const DublicateStackIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	...
	const primary = (
		<svg
			...
			ref={forwardedRef}
		>
			<g clip-path='url(#clip0_8945_10528)'>
				<path
...
export default React.memo(DublicateStackIcon)
