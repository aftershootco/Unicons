...
export const FolderIcon = React.forwardRef<SVGSVGElement, IconProps>(({ variant = 'primary', color = '#fff', size = 24, ...props }, forwardedRef) => {
	// variants

	const primary = (
		<svg width={size} height={size} viewBox='0 0 51 50' fill='none' xmlns='http://www.w3.org/2000/svg' {...props} ref={forwardedRef}>
			<path d='M1.5 1L49.5 49' stroke={color} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
			<path
