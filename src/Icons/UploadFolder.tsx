...
export const UploadFolder = React.forwardRef<HTMLSpanElement, IconProps>((props, forwardedRef) => {
	//props
	const { variant = 'primary', color = DEFAULT_ICON.COLOR, size = DEFAULT_ICON.SIZE, ...restProps } = props

	// variants
	const primary = (
		<svg width={size} height={(21 / 24) * size} viewBox='0 0 24 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
			...
			/>
			<path d='M12 15.6667V9.83335' stroke={color} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
			<path d='M8.5 13.3334L12 9.83337L15.5 13.3334' stroke={color} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
		</svg>
	)
