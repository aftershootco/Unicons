...
const SprayCursorIcon: React.FC<React.SVGProps<SVGSVGElement>> = React.memo((props) => {
	return (
		<svg width='16' height='16' viewBox='0 0 35 35' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			<rect width='35' height='35' rx='17.5' fill='#1B1B1B' fill-opacity='.8' />
			<path
...
export default SprayCursorIcon
