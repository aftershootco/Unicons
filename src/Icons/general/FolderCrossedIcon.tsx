...
export const FolderCrossedIcon = React.forwardRef<HTMLSpanElement, IconProps>((props, forwardedRef) => {
	// props
	const { variant = 'primary', color = DEFAULT_ICON.COLOR, size = DEFAULT_ICON.SIZE, ...restProps } = props

	// variants
	const primary = (
		<svg width={size} height={size} viewBox='0 0 51 50' fill='none' xmlns='http://www.w3.org/2000/svg'>
...
export default React.memo(FolderCrossedIcon)
