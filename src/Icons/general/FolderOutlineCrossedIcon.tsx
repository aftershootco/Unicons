...
const FolderOutlineCrossedIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	...
	const primary = (
		<svg width={size} height={size} viewBox='0 0 51 50' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path d='M1.5 1L49.5 49' stroke={modifiedColor} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
			<path
