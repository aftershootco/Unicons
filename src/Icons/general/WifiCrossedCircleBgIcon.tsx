...
export const WifiCrossedCircleBgIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
	...
	const primary = (
		<svg width={size} height={size} viewBox='0 0 96 96' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<rect width='96' height='96' rx='48' fill={bgColor} fill-opacity='0.3' />
...
export default React.memo(WifiCrossedCircleBgIcon)
