...
export const FailFillIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
	...
	// variants
	const primary = (
		<svg width={(36 / 37) * size} height={size} viewBox='0 0 37 36' fill='none' xmlns='http://www.w3.org/2000/svg'>
