...
export const AftershootEditIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	...
	// variants
	const primary = (
		<svg width={size} height={(13 / 153) * size} viewBox='0 0 156 13' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
