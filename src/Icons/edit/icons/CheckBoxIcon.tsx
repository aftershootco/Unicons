...
export const CheckBoxIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const { variant = 'primary', color = DEFAULT_ICON.COLOR, fillColor = '#2279CE', size = DEFAULT_ICON.SIZE, inActive = false, ...restProps } = props
	...
	const primary = (
		<svg width={size} height={size} viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			<rect x='2' y='2' width='12' height='12' rx='1' fill={fillColor} />
			<path
				fill-rule='evenodd'
				clip-rule='evenodd'
