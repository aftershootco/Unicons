...
export const CheckIcon = React.forwardRef<SVGSVGElement, IconProps>(({ variant = 'primary', color = '#fff', size = 24, ...props }, forwardedRef) => {
	// variants
	...
	const secondary = (
		<svg width={size} height={(6 / 7) * size} viewBox='0 0 7 6' fill='none' xmlns='http://www.w3.org/2000/svg' {...props} ref={forwardedRef}>
			<path
				fill-rule='evenodd'
				clip-rule='evenodd'
