...
export const CreateprofileIcon = React.forwardRef<HTMLSpanElement, IconProps>((props, forwardedRef) => {
	//props
	...
	const primary = (
		<svg width={size} height={size} viewBox='0 0 28 28' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g clip-path='url(#clip0_1324_159976)'>
				...
				/>
				<path d='M16.3333 7.08301H16.345' stroke={color} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
				<path
