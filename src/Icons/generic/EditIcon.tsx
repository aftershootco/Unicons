...
export const EditIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
		...
		<svg width={size} height={size} viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g clip-path='url(#clip0_13023_6690)'>
				...
				<path
					...
					stroke-linejoin='round'
				/>
				<path d='M12 3.75L14.25 6' stroke={modifiedColor} stroke-linecap='round' stroke-linejoin='round' />
			</g>
			<defs>
