...
const QuestionMarkIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	// props
	...
	const secondary = (
		<svg width={(10 / 14) * size} height={size} viewBox='0 0 10 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
