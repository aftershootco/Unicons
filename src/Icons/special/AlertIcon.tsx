...
type IconVariant = 'default' | 'triangle' | 'triangleFill' | 'circle'
...
export const AlertCircleIcon = React.forwardRef<SVGSVGElement, Props>(
	({ variant = 'default', color = '#fff', bgColor = '#1DA0BC', size = 24, ...props }, forwardedRef) => {
		// VARIANTS
			...
			<svg width={size + 1} height={size} viewBox='0 0 21 20' fill='none' xmlns='http://www.w3.org/2000/svg' {...props} ref={forwardedRef}>
				<g id='alert-circle' clip-path='url(#clip0_104_75)'>
					<path
						...
						fill={bgColor}
					/>
					<path id='Vector_2' d='M10.5 6.66666V9.99999' stroke={color} stroke-linecap='round' stroke-linejoin='round' />
					<path id='Vector_3' d='M10.5 13.3333H10.5083' stroke={color} stroke-linecap='round' stroke-linejoin='round' />
				</g>
				<defs>
		...
		const triangleFill = (
			...
			>
				<path
					...
					fill={bgColor}
				/>
				<path d='M26.552 15.507V25.67m0 10.165h.025' stroke={color} stroke-width='5' stroke-linecap='round' stroke-linejoin='round' />
			</svg>
		)
