...
export const MidPowerIcon = React.forwardRef<HTMLSpanElement, Props>((props, forwardedRef) => {
	//props
	const { variant = 'default', size = DEFAULT_ICON.SIZE, ...restProps } = props

	// variants
	const _default = (
		<svg width={(8 / 11) * size} height={size} viewBox='0 0 8 11' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
	...
	return <BaseIcon variants={{ default: _default, enable }} variant={variant} {...restProps} ref={forwardedRef} />
})
