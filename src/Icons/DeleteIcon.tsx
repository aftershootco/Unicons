	...
	const primary = (
		<svg width={size} height={size} viewBox='0 0 97 96' fill='none' xmlns='http://www.w3.org/2000/svg' {...props} ref={forwardedRef}>
			...
			<g clip-path='url(#clip0_13360_17518)'>
				...
				<path d='M43.1667 45.3335V61.3335' stroke={color} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
				<path d='M53.8333 45.3335V61.3335' stroke={color} stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
				<path
