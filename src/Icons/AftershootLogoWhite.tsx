...
export const AftershootLogoWhite = React.forwardRef<HTMLSpanElement, IconProps>((props, forwardedRef) => {
	//props
	const { variant = 'primary', color = DEFAULT_ICON.COLOR, size = DEFAULT_ICON.SIZE, ...restProps } = props

	// variants
	const primary = (
		<svg width={size} height={(30 / 32) * size} viewBox='0 0 32 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
...
export default React.memo(AftershootLogoWhite)
